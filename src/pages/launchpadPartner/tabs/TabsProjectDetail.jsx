                            ...
                            <div className="row no-gutters mb-4">
                                <div className="col-12">
                                    ...
                                    <div className="pl-4">
                                        <div className="row no-gutters mb-2">
                                            <div className="col-6">
                                                <p className="text-white font-16 font-weight-bold mb-0">Minimum Buy</p>
                                            </div>
                                            <div className="col-6">
                                                <p className="text-white font-roboto font-14 mb-0">10</p>
                                            </div>
                                        </div>
                                        <div className="row no-gutters mb-2">
                                            <div className="col-6">
                                                <p className="text-white font-16 font-weight-bold mb-0">Phase 1</p>
                                            </div>
                                            <div className="col-6">
                                                <p className="text-gold font-roboto font-14 font-weight-bold mb-0" style={{letterSpacing: "2px"}}>Start Date : <span style={{letterSpacing: "0.6px"}} className="text-white font-weight-normal font-14">22 Januari 2021, 09:00</span></p>
                                                <p className="text-gold font-roboto font-14 font-weight-bold mb-0" style={{letterSpacing: "2px"}}>End Date : <span style={{letterSpacing: "0.6px"}} className="text-white font-weight-normal font-14">28 Januari 2021, 09:00</span></p>
                                                <p className="text-gold font-roboto font-14 font-weight-bold mb-0" style={{letterSpacing: "2px"}}>Amount : <span style={{letterSpacing: "0.6px"}} className="text-white font-weight-normal font-14">100.000</span></p>
                                            </div>
                                        </div>
                                        <div className="row no-gutters mb-2">
                                            <div className="col-6">
                                                <p className="text-white font-16 font-weight-bold mb-0">Phase 2</p>
                                            </div>
                                            <div className="col-6">
                                                <p className="text-gold font-roboto font-14 font-weight-bold mb-0" style={{letterSpacing: "2px"}}>Start Date : <span style={{letterSpacing: "0.6px"}} className="text-white font-weight-normal font-14">28 Januari 2021, 09:00</span></p>
                                                <p className="text-gold font-roboto font-14 font-weight-bold mb-0" style={{letterSpacing: "2px"}}>End Date : <span style={{letterSpacing: "0.6px"}} className="text-white font-weight-normal font-14">05 Februari 2021, 09:00</span></p>
                                                <p className="text-gold font-roboto font-14 font-weight-bold mb-0" style={{letterSpacing: "2px"}}>Amount : <span style={{letterSpacing: "0.6px"}} className="text-white font-weight-normal font-14">200.000</span></p>
                                            </div>
                                        </div>
                                        <div className="row no-gutters mb-2">
                                            <div className="col-6">
                                                <p className="text-white font-16 font-weight-bold mb-0">Phase 3</p>
                                            </div>
                                            <div className="col-6">
                                                <p className="text-gold font-roboto font-14 font-weight-bold mb-0" style={{letterSpacing: "2px"}}>Start Date : <span style={{letterSpacing: "0.6px"}} className="text-white font-weight-normal font-14">05 Februari 2021, 09:00</span></p>
                                                <p className="text-gold font-roboto font-14 font-weight-bold mb-0" style={{letterSpacing: "2px"}}>End Date : <span style={{letterSpacing: "0.6px"}} className="text-white font-weight-normal font-14">12 Februari 2021, 09:00</span></p>
                                                <p className="text-gold font-roboto font-14 font-weight-bold mb-0" style={{letterSpacing: "2px"}}>Amount : <span style={{letterSpacing: "0.6px"}} className="text-white font-weight-normal font-14">700.000</span></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
