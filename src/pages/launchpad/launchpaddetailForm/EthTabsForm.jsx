        ...
        <div className="container-fluid">
            <div className="row no-gutters mb-2">
                ...
                <div className="col-12 col-md-6 text-left text-sm-right">
                    ...
                    <p className="text-white font-roboto font-16 mb-0">0.000010121 ETH</p>
                </div>
            </div>
                ...
                <div className="col-12 col-md-12">
                    <div className="input-group ci-inputDefault-border">
                        ...
                        <div className="ci-inputDefault-border-appendR">
                            <label className="text-gold font-roboto font-14 mb-0 ci-inputDefault-border-appendL-icon">ETH</label>
                        </div>
                    </div>
                </div>
            </div>
