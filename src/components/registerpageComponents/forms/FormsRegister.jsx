    ...
    <>
      <form className="ci-registerForm mt-4">
          <div className="row">
              ...
              <div className="col-lg-12">
                  <div className="form-group mb-2">
                      <label className="font-14 text-white mb-0">Confirm Password</label>
                      <div className="input-group ci-inputDefault-border">
                          <div className="ci-inputDefault-border-appendL">
                              <i data-feather="key" className="fas fa-key ci-inputDefault-border-appendL-icon text-white"></i>
                          </div>
                          <input value={password2} onChange={e => setPassword2(e.target.value)} type={`${eyes2.typeInputs}`} className="form-control ci-inputDefault-border-input" placeholder="Confirm Password" required=""/>
                  ...
                  <div className="d-flex justify-content-between">
                      <div className="form-group mb-0">
                          <div className="custom-control custom-switch switch-secondary">
                              ...
                              <label className="font-12 custom-control-label text-muted text-white" for="customSwitchSuccess">I Agree to 
              ...
              <div className="col-lg-12 mb-0">
                  <button onClick={handleClickRegister} className="ci-btn-warning ci-md w-100 font-weight-bold" style={{background: "#f9ba42", borderRadius: "8px"}} disabled={!(email && phone && username && (password === password2) && checkAgree)}>Register</button>
              </div>

              <div className="col-12 text-center">
                  <p className="mb-0 mt-3"><small className="text-white mr-2">Have an account ?</small> <span className="text-white font-weight-bold" onClick={() => history.push('/login')} style={{borderBottom:"1px solid white", cursor: "pointer"}}>Sign in</span><small className="text-white ml-2">now</small></p>
              </div>
          </div>
      </form>
    </>
