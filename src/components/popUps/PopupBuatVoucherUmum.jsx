...
function PopupBuatVoucherUmum(props) {
  const title = props.value.title; 
  const text = props.value.text;

  return (
    <div className={props.showPopupBuatVocherUmum ? 'show-popup' : 'hide-popup'}>
              ...
              <div className="container">
                  ...
                  <div className="row mt-3 d-flex justify-content-center">
                      <div className="col-12 col-md-3 d-flex justify-content-center">
                          <button onClick={() => props.setShowPopupBuatVocherUmum(false)} className="ci-btn-warning ci-lg w-100">OK</button>
                      </div>
                  </div>
              </div>
          </div>
...
export default PopupBuatVoucherUmum
