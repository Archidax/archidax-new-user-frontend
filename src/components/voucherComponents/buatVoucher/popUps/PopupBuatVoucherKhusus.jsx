...
function PopupBuatVoucherKhusus(props) {
  ...
  return (
    <div className={props.showPopupBuatVocherKhusus ? 'show-popup' : 'hide-popup'}>
              ...
              <div className="container">
                  ...
                  <div className="row mt-3 d-flex justify-content-center">
                      <div className="col-12 col-md-3 d-flex justify-content-center">
                          <button onClick={() => props.setShowPopupBuatVocherKhusus(false)} className="ci-btn-warning ci-lg w-100">OK</button>
                      </div>
                  </div>
              </div>
          </div>
