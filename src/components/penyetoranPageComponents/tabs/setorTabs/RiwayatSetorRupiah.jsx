...
const tableHeader = ["Waktu", "Jenis", "Jumlah", "Keterangan", "Status"];

export default function RiwayatSetorRupiah() {
  const riwayat = useSelector(
    (state) => state.riwayatReducer.riwayatSetorRupiah
  );
  const numberOfPages = useSelector(
    (state) => state.riwayatReducer.pagesRiwayatSetorRupiah
  );
  const dispatch = useDispatch();
  const totalDocs = useSelector(
    (state) => state.riwayatReducer.totalDocsRiwayatSetorRupiah
  );
              ...
              <div className="col-12 col-md-8">
                <div className="row h-100">
                  <div className="col-12 col-md-4 select-wrapper">
                    <select
                      className="select  w-100 h-100 font-12 pl-2"
                      onChange={(e) => setMonth(e.target.value)}
                    >
                      <option className="ml-3" value="" selected>
                        Semua
                      </option>
                      <option className="ml-3" value="1">
                        {" "}
                        Januari
                      </option>
                      <option className="ml-3" value="2">
                        Februari
                      </option>
                      <option className="ml-3" value="3">
                        Maret
                      </option>
                      <option className="ml-3" value="4">
                        April
                      </option>
                      <option className="ml-3" value="5">
                        Mei
                      </option>
                      <option className="ml-3" value="6">
                        Juni
                      </option>
                      <option className="ml-3" value="7">
                        Juli
                      </option>
                      <option className="ml-3" value="8">
                        Agustus
                      </option>
                      <option className="ml-3" value="9">
                        September
                      </option>
                      <option className="ml-3" value="10">
                        Oktober
                      </option>
                      <option className="ml-3" value="11">
                        November
                      </option>
                      <option className="ml-3" value="12">
                        Desember
                      </option>
                    </select>
                  </div>
                  <div className="col-12 col-md-4 select-wrapper">
                    ...
                    >
                      ...
                      <option className="ml-3" value="2021">
                        {" "}
                        2021
                      </option>
                      <option className="ml-3" value="2022">
                        2022
                      </option>
                      <option className="ml-3" value="2023">
                        2023
                      </option>
                      <option className="ml-3" value="2024">
                        2024
                      </option>
                      <option className="ml-3" value="2025">
                        2025
                      </option>
                      <option className="ml-3" value="2026">
                        2026
                      </option>
                      <option className="ml-3" value="2027">
                        2027
                      </option>
                      <option className="ml-3" value="2028">
                        2028
                      </option>
                      <option className="ml-3" value="2029">
                        2029
                      </option>
                      <option className="ml-3" value="2030">
                        2030
                      </option>
                    </select>
                  </div>
                  <div className="col-12 col-md-4">
                    <button
                      className="select w-100 font-12"
                      onClick={() => filter()}
                    >
                      Filter
                    </button>
                ...
                <thead>
                  <tr>
                    {tableHeader.map((head, index) => {
                      return (
                        <th scope="col" key={index} className="table-header">
                          {head}
                        </th>
                      );
                    })}
